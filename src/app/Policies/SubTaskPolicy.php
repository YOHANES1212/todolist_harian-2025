...
class SubTaskPolicy
{
    ...
    {
        return $user->can('view_any_sub::task');
    }
    ...
    {
        return $user->can('create_sub::task');
    }
    ...
    {
        return $user->can('update_sub::task');
    }
    ...
    {
        return $user->can('delete_sub::task');
    }
    ...
    {
        return $user->can('delete_any_sub::task');
    }
     ...
     */
    public function replicate(User $user, SubTask $subTask): bool
    {
